...
public class ZkConnector implements Watcher {
    ...
    protected byte[] getData(String path, Stat stat) {
        ...
        byte[] ret = null;
        try {
            ret = zooKeeper.getData(path, true, stat);
        } catch(Exception e) {
        }
    ...
    protected ArrayList<String> getChildren(String path, Watcher watch) {

        ArrayList<String> ret = new ArrayList<String>();
        try {
            ret = (ArrayList<String>) zooKeeper.getChildren(path, watch);
        } catch(Exception e) {System.out.println ("Exception in ZkConnector.getChildren");
        }
